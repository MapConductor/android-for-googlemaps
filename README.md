# Google Maps SDK for MapConductor Android

## Description

MapConductor provides a unified API for Android Jetpack Compose.
You can use Google Maps view with Jetpack Compose, but you can also switch to other Maps SDKs (such as MapLibre, HERE, and so on), anytimes.
...
### GoogleMapView [[docs]](https://docs-android.mapconductor.com/components/mapviewstate/)
